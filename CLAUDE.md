...
- **Large structures**: 90 animated multi-tile structures defined in `LargeStructures.ts`. Sprites generated by `large_structure_sprites.tsx` with faction ground tiles baked in. Structure PNGs in `assets/terrain/structures/`.
