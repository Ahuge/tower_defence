...
export const TOWER_TYPES: Record<string, TowerType> = {
  ...
  alien_brood_mother: def({
    ...
    traits: [{ id: 'direct_damage' }, { id: 'spawn_swarmlings_per_wave', count: 2 }, { id: 'swarm_commander', buffRange: 6, damagePercent: 0.20, ratePercent: 0.15, targetIds: ['alien_swarmling'] }],
    upgrades: [
