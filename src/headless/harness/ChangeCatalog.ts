...
const HARMONIC: BalanceChange[] = [
  ...
  { id: 'harm.4',  faction: 'harmonic', description: '[buff] Amplifier 15%→20% per stack (multiplicative)',
    apply: p => p.patchTrait('harmonic_amplifier', 'damage_aura', 'percent', 0.20) },
  { id: 'harm.5',  faction: 'harmonic', description: '[buff] Amplifier cost 30→20',
    apply: p => p.patchTower('harmonic_amplifier', 'cost', 20) },
  { id: 'harm.6',  faction: 'harmonic', description: '[buff] Quickener 10%→15% per stack (multiplicative)',
    apply: p => p.patchTrait('harmonic_quickener', 'rate_aura', 'percent', 0.15) },
  { id: 'harm.7',  faction: 'harmonic', description: '[buff] Quickener cost 40→30',
    apply: p => p.patchTower('harmonic_quickener', 'cost', 30) },
  { id: 'harm.8',  faction: 'harmonic', description: '[buff] Reach 10%→15% per stack (multiplicative)',
    apply: p => p.patchTrait('harmonic_reach', 'range_aura', 'percent', 0.15) },
  { id: 'harm.9',  faction: 'harmonic', description: '[buff] Reach cost 50→35',
    apply: p => p.patchTower('harmonic_reach', 'cost', 35) },
  { id: 'harm.10', faction: 'harmonic', description: '[buff] Critical Mass chance 20%→25% per stack (asymptotic compound)',
