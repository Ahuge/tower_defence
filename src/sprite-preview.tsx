...
const modules: Record<string, () => Promise<{ default: React.ComponentType }>> = {
  ...
  'terrain-arcane': () => import('../arcane_terrain_sprites'),
  'terrain-mechanical': () => import('../mechanical_terrain_sprites'),
  'terrain-nature': () => import('../nature_terrain_sprites'),
  'terrain-void': () => import('../void_terrain_sprites'),
  'terrain-military': () => import('../military_terrain_sprites'),
  'terrain-aliens': () => import('../aliens_terrain_sprites'),
  ...
  'mech-campaign': () => import('../mech_campaign_sprites'),
...
const FACTION_FILE_MAP: Record<string, { dir: string; canvases: string[] }> = {
  ...
  'terrain-arcane':     { dir: 'terrain', canvases: ['arcane_terrain_tileset', 'arcane_terrain_doodads'] },
  'terrain-mechanical': { dir: 'terrain', canvases: ['mechanical_terrain_tileset', 'mechanical_terrain_doodads'] },
  'terrain-nature':     { dir: 'terrain', canvases: ['nature_terrain_tileset', 'nature_terrain_doodads'] },
  'terrain-void':       { dir: 'terrain', canvases: ['void_terrain_tileset', 'void_terrain_doodads'] },
  'terrain-military':   { dir: 'terrain', canvases: ['military_terrain_tileset', 'military_terrain_doodads'] },
  'terrain-aliens':     { dir: 'terrain', canvases: ['aliens_terrain_tileset', 'aliens_terrain_doodads'] },
  ...
  'mech-campaign':      { dir: 'arena', canvases: ['struct_workshop', 'struct_suppression_pylon', 'struct_generator', 'raider', 'struct_voss_throne'] },
};
