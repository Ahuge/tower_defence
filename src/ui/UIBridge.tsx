...
export type ScreenId = 'menu' | 'store' | 'battlepass' | 'inventory' | 'factionselect' | 'heroselect' | 'creepfactionselect' | 'draft' | 'gauntletpreview' | 'gameover' | 'changelog' | 'leaderboard' | 'encyclopedia' | 'settings' | null;
