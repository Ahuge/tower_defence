...
export type ScreenId = 'menu' | 'store' | 'battlepass' | 'inventory' | 'factionselect' | 'heroselect' | 'creepfactionselect' | 'draft' | 'gauntletpreview' | 'gameover' | 'changelog' | 'leaderboard' | 'encyclopedia' | 'settings' | 'lobby' | 'circle-lobby' | 'campaign-lobby' | 'campaign-menu' | 'faction-tree' | null;
