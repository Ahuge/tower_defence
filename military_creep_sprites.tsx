  ...
  return (
    <div style={{ background: '#0a0f06', minHeight: '100vh', padding: 12, fontFamily: 'monospace' }}>
      ...
      <div style={{ overflowX: 'auto', overflowY: 'auto', maxHeight: '85vh' }}>
        <canvas ref={pvRef} data-label="Military Creeps (Preview)" data-frame-size="32x32" data-direction="right" data-columns='["Infantry","Scout","Heavy Trooper","Recruit","Field Medic","Tank Commander","Fire Team","Cargo Carrier","Riot Trooper","Recon Operative","Combat Engineer","Paratrooper","Armor Officer","Signals Officer","Smoke Operator","Combat Surgeon"]' data-rows='["Walk 1","Walk 2","Walk 3","Walk 4","Death 1","Death 2","Death 3"]' data-presets='[{"name":"Walk","startRow":0,"endRow":3},{"name":"Death","startRow":4,"endRow":6}]' style={{ display: view === 'preview' ? 'block' : 'none', maxWidth: '100%' }} />
        <canvas ref={cRef} data-label="Military Creeps" data-frame-size="32x32" data-direction="right" data-columns='["Infantry","Scout","Heavy Trooper","Recruit","Field Medic","Tank Commander","Fire Team","Cargo Carrier","Riot Trooper","Recon Operative","Combat Engineer","Paratrooper","Armor Officer","Signals Officer","Smoke Operator","Combat Surgeon"]' data-rows='["Walk 1","Walk 2","Walk 3","Walk 4","Death 1","Death 2","Death 3"]' data-presets='[{"name":"Walk","startRow":0,"endRow":3},{"name":"Death","startRow":4,"endRow":6}]' style={{ display: view === 'actual' ? 'block' : 'none', imageRendering: 'pixelated', width: COLS * CELL * 2, border: '1px solid #1a2a1a' }} />
      </div>
